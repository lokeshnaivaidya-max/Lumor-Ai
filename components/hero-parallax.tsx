...
export function HeroParallax() {
  ...
  const startFreeHref = session?.user ? "/dashboard" : "/sign-up"
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1320px] flex-col justify-center px-6 py-28 lg:px-10">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6">
            ...
            >
              <Link href={startFreeHref} className="btn btn--gold btn--lg">Get started free <ArrowRight className="h-4 w-4" /></Link>
