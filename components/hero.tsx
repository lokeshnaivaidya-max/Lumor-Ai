    ...
    >
      <motion.div style={{ y, opacity }} className="relative z-10 w-full max-w-6xl">
        ...
        <motion.div
          ...
          className="mx-auto mb-9 flex w-fit items-center gap-2 rounded-full glass px-4 py-1.5 text-xs tracking-wide text-muted-foreground"
        >
        ...
        {/* Headline — editorial */}
        <h1 className="text-center text-[3.25rem] font-semibold leading-[0.92] tracking-[-0.03em] text-balance sm:text-7xl lg:text-[7.5rem]">
          ...
          <span className="mt-1 block">
            ...
            <Word delay={0.34}>
              <span className="font-serif text-[0.92em] italic font-normal text-foreground/90">by AI.</span>
            </Word>
          </span>
        </h1>
      ...
      >
        ...
        <motion.div
          ...
          className="animate-float absolute -left-3 top-6 hidden w-60 rounded-2xl glass-strong p-4 sm:block"
        >
        ...
        <motion.div
          ...
          className="animate-float absolute -right-3 bottom-10 hidden w-56 rounded-2xl glass-strong p-4 md:block"
          ...
          <div className="mt-2 flex items-end gap-1">
            {[38, 52, 46, 68, 60, 82, 74, 91].map((h, i) => (
              <motion.div
                ...
                style={{
                  background: "linear-gradient(to top, oklch(0.68 0.17 250 / 0.35), oklch(0.8 0.14 168))",
                }}
              />
            ))}
          </div>
