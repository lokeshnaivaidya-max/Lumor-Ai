    ...
    <>
      ...
      <header className="relative z-30 mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-6">
        <Link href="/" className="flex items-center gap-2.5 text-foreground">
          ...
          <span className="font-medium tracking-tight">Lumora</span>
        </Link>
        <Link
          href="/"
          className="flex items-center gap-1.5 rounded-full border border-border px-4 py-2 text-sm text-muted-foreground transition-colors hover:border-foreground/30 hover:text-foreground"
        >
      ...
      <main className="relative z-10">
        <div className="mx-auto w-full max-w-6xl px-4 pb-2 pt-4">
          <p className="text-xs font-medium uppercase tracking-[0.3em] text-accent">Markets Terminal</p>
          <h1 className="mt-3 text-balance text-4xl font-medium tracking-tight text-foreground sm:text-5xl">
            Search any market. See the signal.
          </h1>
