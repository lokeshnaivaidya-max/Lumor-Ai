            ...
            <div className="flex flex-wrap justify-center gap-2">
              {[
                ...
                <button
                  ...
                  className="chip chip-gold cursor-pointer transition-colors hover:bg-[var(--gold)] hover:text-[var(--bg)]"
                >
                  {pair.a} <span className="px-1 text-[var(--text-tertiary)]">vs</span> {pair.b}
                </button>
              ))}
            </div>
          </div>
