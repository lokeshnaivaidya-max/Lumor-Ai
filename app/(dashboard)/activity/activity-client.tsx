  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="page-head mb-8 glow-page">
        ...
        <p className="body mt-2">A live feed of everything you do across Lumora, newest first.</p>
      </motion.div>
        ...
        <div className="bento-card overflow-hidden">
          <ul className="divide-y divide-[var(--line)]">
            {items.map((item, i) => {
              ...
              const body = (
                <div className="flex items-center gap-4 px-5 py-4 transition-colors duration-200 hover:bg-[var(--panel-2)]">
              ...
              return (
                <motion.li key={item.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: Math.min(i * 0.03, 0.4) }}>
